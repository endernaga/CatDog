...
export const AnimalButton: React.FC<AnimalProps> = ({ to, title }) => {
  const getLinkClass = ({ isActive }: { isActive: boolean }) =>
    classNames('animalButton', {
      'animalButton--active': isActive,
    });
