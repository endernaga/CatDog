...
import { contactsButtons } from "../../utils/socialMedias";
    ...
    <div className="contacts">
      ...
      <div className="contacts__carts">
        <div className="contacts__carts__item">
          ...
          <p className="contacts__carts__text">424, 376 маршрутка від м. Академістечко</p>
        </div>
        <div className="contacts__carts__item">
          <div className="icon icon-car" /> 
          <p className="contacts__carts__text">30 хвилин машиною від м. Академмістечко</p>
        </div>
      </div>
...
export const Contacts2 = () => {
  return (
    <div className="contacts2">
      <BreadCrumb title1="Контакти" />
      <BigSectionsHeader text={["Супер", "Друзі"]} />
      <div className="contacts2__header">
      <div className="contacts2__text">
      ...
      <iframe
        ...
        width="1344"
        height="455"
        className="contacts2__map"
        allowFullScreen={true}
        loading="lazy"
        referrerPolicy="no-referrer-when-downgrade"
      ></iframe>
      <div className="contacts2__carts">
        <div className="contacts2__carts__item">
          <div className="icon icon-bus" /> 
          <p className="contacts2__carts__text">424, 376 маршрутка від м. Академістечко</p>
        </div>
        <div className="contacts2__carts__item">
          <div className="icon icon-car" /> 
          <p className="contacts2__carts__text">30 хвилин машиною від м. Академмістечко</p>
        </div>
      </div>

      <div className="contacts2__content">
      <div className="contacts2__header">
           <div className="contacts2__text">
          Середа-неділя
          <br /> з 11:00 до 16:00
      ...
      <div className="contacts2__links">
        <div className="contacts__links__item">
